...
var Alert = /** @class */ (function () {
    ...
    Alert.prototype.render = function () {
        ...
        var classes = classnames((_a = {
            ...
            _a["alert-" + this.kind] = true,
            _a['alert-dismissible'] = this.onDismiss,
            _a));
        return (h("div", { class: classes }, this.content || h("slot", null), this.onDismiss && (h("button", { type: "button", class: "close", "data-dismiss": "alert", "aria-label": "Close", onClick: this.onDismiss }, h("span", { "aria-hidden": "true" }, "\u00D7")))));
    };
    Object.defineProperty(Alert, "is", {
        get: function () { return "bearer-alert"; },
        enumerable: true,
        configurable: true
    });
